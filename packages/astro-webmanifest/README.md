...
| :---------------------- | :-----------------------------------: | :------: | :--------------------: | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `icon`                  | `String` (part of `Webmanifest` type) |    No    |                        | It's a source to automatically generate icons and favicon.                                                                                                                                         |
...
| `indent`                |               `String`                |    No    |    four space chars    | Leading characters for every line in `<head>` to make output more readable.                                                                                                                        |
| `eol`                   |               `String`                |    No    |          `\n`          | Trailing characters for every line in `<head>` to make output more readable..                                                                                                                      |
|                         |                                       |          |                        | Set it to `""` to save few bytes on html output.                                                                                                                                                   |
