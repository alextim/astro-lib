...
| - `crossOrigin`           | `anonymus` \| `use-credentials` |    No    |       `anonymus`       | `crossorigin` attribute for manifest link in `<head>`. More details on [MDN](https://developer.mozilla.org/en-US/docs/Web/HTML/Attributes/crossorigin)                                                                                                                                                                                                                                                    |
